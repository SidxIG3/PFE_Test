                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-5">
                                ...
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    ...
                                    <div class="card-header"><h4 class="text-center font-weight-light my-4" style="font-size: 2rem; font-family: Segoe UI;">Modifier les informations de  letter de change</h4></div>
                                    <div class="card-body">
                                    	
                                        <form:form  modelAttribute="billets_a_ordres"  action="/enregistrerBillet" method="POST">
                                         <div class="form-group">
												
												<form:input path="numero_BO" class="form-control py-4 form-control-user" id="inputecheance" type="hidden" required="required"  style="font-size: 1rem; font-family: Segoe UI;" />                                        
                                            </div>
                                            <div class="form-group">
