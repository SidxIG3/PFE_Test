                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-5">
                                ...
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    ...
                                    <div class="card-header"><h4 class="text-center font-weight-light my-4" style="font-size: 2rem; font-family: Segoe UI;">Modification des informations de letter de change</h4></div>
                                    <div class="card-body">
                                    	
                                        <form:form  modelAttribute="lettres_de_changes"  action="/enregistrerLetter" method="POST">
                                            <div class="form-group">
											<form:input path="numero_LC" class="form-control py-4 form-control-user" id="inputecheance" type="hidden" required="required" style="font-size: 1rem; font-family: Segoe UI;" />                                        
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
												<label class="small mb-1" for="inputPassword" style="font-size: 1rem; font-family: Segoe UI;">Lieu de creation</label>
												<form:input path="lieu_creation" class="form-control py-4 form-control-user" id="inputLieuC" type="text" required="required" placeholder="Votre Lieu de creation" style="font-size: 1rem; font-family: Segoe UI;" />                                        
                                            </div>
						                    ...
						                    <div class="dataTables_length" id="dataTables_length">
						                     <label>id_tire</label>
						                     <form:select path="clients.id_client" class="custom-select custom-select-sm form-control form-control-sm"  items="${clients}" itemLabel="nom_client" itemValue="id_client">
						                     </form:select>
						                    </div>
